...
from currency.exceptions.root_exception import BadRequestException
...
class ConfigurationError(Exception):
    def __init__(self, model_name, config_option, error_message):
        super().__init__(
            f"Invalid option in {model_name}.Meta: {config_option}: {error_message}")
        self.model_name = model_name
        self.config_option = config_option
        self.error_message = error_message


class AbstractRootHistory(models.Model):
    ...
    def _is_keep_history(self, original_instances):
        try:
            ...
            raise ConfigurationError(
                original_instances.model.__name__, 'enable_history_if', str(e))
